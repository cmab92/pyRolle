...
if __name__ == '__main__':
    oc_clf = Two_class_svm(window_width=64,
                           window_shift=29,
    ...
    oc_clf.sel_var_subset(ir_vars=np.array([0, 1, 2, 3, 4, 5], dtype=int),
                          fr_vars=np.array([0, 1], dtype=int),
    ...
    # '''
    # normal:
    oc_clf.add_data_files("2019_4_9_14_43_links.txt", start_index=50, stop_index=2100, label=0)
    oc_clf.add_data_files("2019_4_10_11_36_links.txt", start_index=100, stop_index=9500, label=0)
    oc_clf.add_data_files("2019_4_10_11_24_links.txt", start_index=400, stop_index=10000, label=0)
    # not normal:
    oc_clf.add_data_files("2019_4_9_14_41_rechts.txt", start_index=850, stop_index=2450, label=1)
    oc_clf.add_data_files("2019_4_10_11_42_rechts.txt", start_index=1400, stop_index=8400, label=1)
    oc_clf.add_data_files("2019_4_10_11_30_rechts.txt", start_index=1400, stop_index=7400, label=1)
    #'''
