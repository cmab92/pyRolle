...
class One_class_svm:
    ...
    def add_data_files(self, file_source_name, start_index=0, stop_index=10**16, label=None, class_name=None, c_l=None):
        """
        Add a source file to the dataset. Given inputs are stored in arrays.
        ...
        :param label: Label of the file.
        :param class_name: Class name displayed by some functions (self.__liveClassification).
        :param c_l: column length (when ignoring sensors).
        :return: writes to:
         - self.__file_source_name
         - self.__file_source_start_index
         - self.__file_source_stop_index
    ...
    def extract_features(self, data):
        ...
        if self.__num_coefficients != 0:
            for i in range(self.__num_of_used_vars):
                coefficients = pywt.wavedec(data[::, i], wavelet=self.__wavelet, mode='symmetric', level=self.__num_levels)
                for j in range(self.__num_levels):
                    coefficients_0 = coefficients[j]
    ...
    def binary_classify_data(self, ):
        ...
        #    {'C': np.linspace(10, 500, 15), 'gamma': np.linspace(0.0001, 0.001, 10), 'kernel': ['rbf']},
        #]
        ...
        self.__clf = svm.SVC(C=50, kernel='rbf', gamma=0.0002).fit(self.__training_data, self.__training_labels)
...
if __name__ == '__main__':
    ...
    oc_clf.add_data_files("2019_1_15_16_52.txt", start_index=21000, stop_index=26000, label=0)
    oc_clf.add_data_files("2019_1_15_16_52.txt", start_index=36000, stop_index=46000, label=0)
    # not normal:
    ...
    oc_clf.add_data_files("2019_1_15_16_52.txt", start_index=30000, stop_index=33000, label=1)       #
    oc_clf.add_data_files("2019_1_15_16_52.txt", start_index=34600, stop_index=36000, label=1)       #
